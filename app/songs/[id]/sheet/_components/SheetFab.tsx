...
type Sheet = { id: string; sheet_drive_url: string; verified_at: string | null };
...
export default function SheetFab({ sheet, onVerify, onDelete }: Props) {
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full mx-4 text-gray-900">
            ...
            <p className="text-sm text-gray-600 mb-5">
              Bạn có chắc muốn xóa sheet này không? Hành động này không thể hoàn tác.
            </p>
