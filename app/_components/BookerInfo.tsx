...
export default function BookerInfo({ bookerName, singerName, phone, tablePos, onBookerNameChange, onSingerNameChange, onPhoneChange, onTablePosChange, onUserIdChange }: Props) {
