...
function ActorSearch({ onSelect }: { onSelect: (userId: string, name: string) => void }) {
...
export default function TracesPage() {
  ...
  const columns: Column<AuditLog>[] = [
    ...
    },
    {
      key: "entity_type",
      header: "Loại",
      cellClassName: "text-xs font-medium text-gray-700 dark:text-gray-200",
    ...
    },
    {
      ...
      cellClassName: "hidden lg:table-cell font-mono text-xs text-gray-500 dark:text-gray-400",
    ...
    },
    {
      ...
      cellClassName: "hidden xl:table-cell font-mono text-xs text-gray-500 dark:text-gray-400",
    ...
    },
    {
      ...
      header: "Device",
      headerClassName: "hidden xl:table-cell",
      cellClassName: "hidden xl:table-cell text-xs text-gray-400 dark:text-gray-500 max-w-[200px] truncate",
      cell: log =>
        log.user_agent ? (
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto py-6 px-4">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Lịch sử hành động</h1>
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          ...
          <ActorSearch
            onSelect={(uid) => { setActorUserId(uid); setOffset(0); }}
          />
          ...
          <input
            ...
            className={selectCls + " sm:w-40 font-mono"}
          />
          ...
          <input
            ...
            className={selectCls + " sm:w-64 font-mono"}
          />

          {(actorUserId || ipFilter || entityId) && (
            <button
